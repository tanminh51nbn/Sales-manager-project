                                ...
                                do{
                                    ...
                                    switch(n){
                                        case 1:
                                            system("cls");
                                            Admin_Display_3_1();
                                            gotoxy((short)26,(short)3); cin>>id;
                                            gotoxy((short)23,(short)4); cin>>sl;
                                            cout<<endl<<endl<<"Xac nhan (y/n): "; cin>>s;
                                            if(s=="y"){
                                                for(int i=0;i<get_data.size();i++){
                                                    if(id==get_data[i].get_id()){
                                                        get_data[i].them(sl);
                                                        retype(get_data);
                                                        cout<<endl<<"Thanh cong !!!!"<<endl<<endl;
                                                        system("pause");
                                                        break;
                                                    } else {
                                                        cout<<endl<<"Khong ton tai vat pham co ID la: \""<<id<<"\""<<endl;
                                                        system("pause");
                                                        break;
                                                    }
                                                }
                                        ...
                                        case 2:
                                            system("cls");
                                            Admin_Display_3_2();
                                            gotoxy((short)31,(short)3); cin>>id;
                                            gotoxy((short)13,(short)4); cin>>gia;
                                            cout<<endl<<endl<<"Xac nhan (y/n): "; cin>>s;
                                            if(s=="y"){
                                                for(int i=0;i<get_data.size();i++){
                                                    if(id==get_data[i].get_id()){
                                                        get_data[i].set_gia(gia);
                                                        retype(get_data);
                                                        cout<<endl<<"Thanh cong !!!!"<<endl<<endl;
                                                        system("pause");
                                                        break;
